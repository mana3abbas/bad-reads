...
export default class Home extends Component {
    ...
    componentDidMount() {
        axios.get('http://${process.env.REACT_APP_PRODUCTION_IP}/home/category')
            .then(res => {
                this.setState({
        ...
        axios.get('http://${process.env.REACT_APP_PRODUCTION_IP}/home/author')
            .then(res => {
                this.setState({
        ...
        axios.get('http://${process.env.REACT_APP_PRODUCTION_IP}/home/book')
            .then(res => {
                this.setState({
