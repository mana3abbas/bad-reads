...
{  
    ...
    handlecategoryNameChange = (e) => {
      ...
      handleCate = () => {
        ...
        axios.patch('http://${process.env.REACT_APP_PRODUCTION_IP}/admin/category/'+this.props.location.state.details._id,{categoryName:this.state.categoryName,  categoryDescription:this.state.categoryDescription}
        ).then(response => {
