...
class HomeBookTable extends Component {
    ...
    componentDidMount() {
        ...
        {   
            ...
            axios.get(`http://${process.env.REACT_APP_PRODUCTION_IP}/userbook/${userId}/${bookId}`)
            .then(res => {
                    this.setState({
                        usersBook: res.data
                    })
    ...
    actionCreate = (e,value) => {
        ...
        axios.post(`http://127.0.0.1:4000/userBook/`, {
            ...
            action = axios.get(`http://${process.env.REACT_APP_PRODUCTION_IP}/userbook/${userId}/${bookId}`)
        .then(res => {
