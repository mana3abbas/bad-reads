...
export default class Category_books extends Component {
  ...
  getBooks = () => {
    ...
    // get category name  
    axios.get(`http://process.env.REACT_APP_PRODUCTION_IP/category/${this.props.match.params.id}/name`)
      .then(res=>{
      ...
      // get category books
      axios.get(`http://process.env.REACT_APP_PRODUCTION_IP/category/${this.props.match.params.id}/${currentPage}`)
      .then(res=>{
      ...
      axios.get(`http://process.env.REACT_APP_PRODUCTION_IP/category/${this.props.match.params.id}/count`)
      .then(res=>{
