...
handleCate = () => {
  ...
  axios.post('http://${process.env.REACT_APP_PRODUCTION_IP}/admin/category', {categoryName:this.state.categoryName,  categoryDescription:this.state.categoryDescription}
  ).then(response => {
